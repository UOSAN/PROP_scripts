...
matlabbatch{2}.spm.stats.con.consess{5}.tcon.weights = [0 1 0 0 0 0];
...
matlabbatch{2}.spm.stats.con.consess{6}.tcon.weights = [0 0 0 1 0 0];
matlabbatch{2}.spm.stats.con.consess{6}.tcon.sessrep = 'repl';
matlabbatch{2}.spm.stats.con.consess{7}.tcon.name = 'cbt > pst';
matlabbatch{2}.spm.stats.con.consess{7}.tcon.weights = [1 0 -1 0 0 0];
matlabbatch{2}.spm.stats.con.consess{7}.tcon.sessrep = 'repl';
matlabbatch{2}.spm.stats.con.consess{8}.tcon.name = 'cbt relevance > pst relevance';
matlabbatch{2}.spm.stats.con.consess{8}.tcon.weights = [0 1 0 -1 0 0];
